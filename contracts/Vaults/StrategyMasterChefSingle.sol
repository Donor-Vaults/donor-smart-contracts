...
contract StrategyMasterChefSingle is StratManager {
    ...
    constructor(
        ...
        address _wrapped,
        address _output
    ) public StratManager(_unirouter) {
        masterchef = _masterChef;
        wrapped = _wrapped;
        output = _output;
        outputToWantRoute = [output, _want];
        want = _want;
    ...
    function withdraw(uint256 _amount) external {
        ...
        if (wantBal < _amount) {
            IMasterChef(masterchef).withdraw(
                poolId,
                _amount.sub(wantBal),
                true
            );
    ...
    function harvest() public whenNotPaused {
        ...
        if (outputToWantRoute[0] != outputToWantRoute[1]) {
