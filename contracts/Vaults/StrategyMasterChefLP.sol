...
interface IMasterChef {
    ...
    function withdraw(uint256 _pid, uint256 _amount,bool isAllowMinimun) external;
...
contract StrategyMasterChefLP is StratManager {
    ...
    constructor(
        ...
        address _wrapped,
        address _output
    ) StratManager( _unirouter) public {
    ...
    function withdraw(uint256 _amount) external {
        ...
        if (wantBal < _amount) {
            IMasterChef(masterchef).withdraw(poolId, _amount.sub(wantBal),true);
